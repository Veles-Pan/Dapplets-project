...
exports.ItemList = function () {
    ...
    useScroll_1["default"](parentRef, childRef, handleScroll);
    ...
    return (react_1["default"].createElement(core_1.DndContext, { onDragEnd: handleOnDragEnd },
        react_1["default"].createElement(sortable_1.SortableContext, { items: items.map(function (i) { return i.id; }) },
            react_1["default"].createElement(ui_search_panel_1.SearchPanel, { setValue: setSearch, value: search, theme: theme, setTheme: setTheme, order: order, setOrder: setOrder }),

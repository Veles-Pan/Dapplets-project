...
exports.Item = function (props) {
    ...
    return (React.createElement("div", { ref: setNodeRef, style: style, className: "item", onClick: function () { return changeOpening(function (prev) { return !prev; }); } },
        ...
        React.createElement("img", { alt: 'icon', className: 'item__icon', src: props.image }),
        ...
        React.createElement("ul", { className: 'item__tags' }, props.item.tags.map(function (tag, index) { return (React.createElement("li", { key: index, className: 'item__tag' },
            props.tags[tag] ? props.tags[tag] : undefined,
            React.createElement("img", { alt: '\u00D7', className: 'item__cross', src: cross_svg_1["default"] }))); })),
        React.createElement("div", { className: 'item__install' },
            React.createElement("p", { className: 'install' }, "Install"),
            React.createElement("img", { alt: 'install', src: download_svg_1["default"], className: 'install_icon' }),
            React.createElement("p", { className: 'uninstall' }, "Uninstall"),
            React.createElement("img", { alt: 'uninstall', src: x_circle_svg_1["default"], className: 'uninstall_icon' })),
        React.createElement("div", { className: "item__extra " + (isExtraOpened ? 'item__extra_opened' : ''), onClick: function (e) { return e.stopPropagation(); } }, extraInfos.map(function (element, index) { return (React.createElement("div", { key: index, className: "item__extra_container item__extra_container" + (index + 1) },

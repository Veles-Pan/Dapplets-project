    ...
    return (React.createElement("div", { className: 'desktop-page' },
        React.createElement("header", { className: 'header' },
            React.createElement("div", { className: 'header__info' },
                React.createElement("img", { alt: 'cloud', src: cloud_svg_1["default"], className: 'header__cloud' }),
            ...
            React.createElement("div", { className: 'header__settings' },
                React.createElement("img", { alt: 'settings', src: settings_svg_1["default"], className: 'header__settings-icon' }),
